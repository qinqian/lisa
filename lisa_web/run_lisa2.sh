...
nice -n 15 lisa model --method="$4" --web=True --new_rp_h5=None --new_count_h5=None --species $1 --epigenome "$2" --cluster=False --covariates=False --random=True --prefix ${outdir} --background=$7 --stat_background_number=300 --threads 4 $5 $6
